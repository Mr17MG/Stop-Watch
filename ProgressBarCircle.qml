...
Item {
    ...
    property int size: 150               // The size of the circle in pixel
    property real arcBegin: 0            // start arc angle in degree
    property real arcEnd: (value *360)/maxVal // end arc angle in degree
    property real arcOffset: 0           // rotation
    property bool isPie: false           // paint a pie instead of an arc
    property bool showBackground: true  // a full circle as a background of the arc
    property real lineWidth: 15          // width of the line
    property string colorCircle: "black"
